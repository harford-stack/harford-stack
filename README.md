...
- Google Gemini AI를 활용한 맞춤형 레시피 생성
...
**개발 기간**: 2025.12.22 ~ 2026.01.08 (2주)

**역할**:
- 로그인 / 회원가입 (이메일, 구글) - Firebase Authentication
- 홈화면, 공통 컴포넌트(Appbar, Drawer, Footer)
- Firebase Firestore, Storage 관리
- UI/UX 개선
...
- 💼 [Portfolio](https://drive.google.com/file/d/1jwnqo_ZpZ5dS_nOIK_S2UrLQiwRhrOnv/view?usp=sharing) - 프로젝트 포트폴리오
- 💷 [Resume](https://drive.google.com/file/d/1d6mfIsbJkk1TTbUT66kGEGhNHC6ythrr/view?usp=sharing) - 이력서 및 자기소개서
